...
public class GpuVmNull implements GpuVm {
    ...
    @Override
    public Vm setBootModel(BootModel model) {
        return this;
    }
    ...
    @Override
    public Vm setFinishTime(double stopTime) {
        return this;
    }
    ...
    @Override
    public Lifetimed setLifeTime(double lifeTime) {
        return this;
    }
