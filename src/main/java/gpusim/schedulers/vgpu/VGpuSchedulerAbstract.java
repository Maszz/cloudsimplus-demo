...
public abstract class VGpuSchedulerAbstract implements VGpuScheduler {
    ...
    public double getTotalAvailableMips() {
        ...
        final double allocatedMips = vgpuStream
    ...
    protected double percentOfMipsToRequest(final VGpu vgpu) {
        ...
        if (gpu.getVGpusMigratingOut().contains(vgpu)) {
             ...
             * Thus, the allocated MIPS for that VM is reduced according to the CPU
             * migration
             * overhead.
             */
        ...
        // VM is not migrating, thus 100% of its requested MIPS will be requested to the
        // Host.
        return 1;
    }
