...
public interface VGpuAllocationPolicy {
     ...
     * <ul>
     * <li>the Vm is overloaded and the Host where the Vm is placed has enough
     * capacity</li>
     * <li>the Vm is underloaded</li>
     * </ul>
     * <p>
     * The resource to be scaled is defined by the given {@link VerticalVmScaling}
     * object.
     *
     * @param scaling the {@link VerticalVmScaling} object with information of which
     *                resource
