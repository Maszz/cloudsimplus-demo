...
public abstract class VGpuAllocationPolicyAbstract implements VGpuAllocationPolicy {
     ...
     * return isRequestingCpuScaling(scaling) ? scaleVmPesUpOrDown(scaling) :
     * upScaleVmNonCpuResource(scaling);
     * }
     */
     ...
     * return isRequestingCpuScaling(scaling) ? scaleVmPesUpOrDown(scaling) :
     * downScaleVmNonCpuResource(scaling);
     * }
     */
    ...
    /*
     * private boolean isNotHostPesSuitableToUpScaleVm(final VerticalVmScaling
     * scaling) {
     */
    ...
    /*
     * private HostSuitability createVGpusFromGroup(final VmGroup vmGroup, final
     * Host host) {
     * int createdVms = 0;
