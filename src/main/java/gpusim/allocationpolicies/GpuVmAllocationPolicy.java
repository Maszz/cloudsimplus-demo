...
public interface GpuVmAllocationPolicy extends VmAllocationPolicy {
     ...
     * 
     * <T extends GpuVm> List<T> allocateGpuHostForGpuVm (Collection<T>
     * gpuvmCollection);
     * 
     ...
     * BiFunction<GpuVmAllocationPolicy, GpuVm, Optional<GpuHost>>
     * findGpuHostForGpuVmFunction);
     * 
     * <T extends GpuHost> List<T> getGpuHostList ();
     * 
     * Map<GpuVm, GpuHost> getOptimizedAllocationMap (List<? extends GpuVm>
     * gpuvmList);
     * 
