...
import gpusim.core.AbstractGpu;
...
public interface VGpu extends AbstractGpu, Comparable<VGpu>,
    ...
    // return getCloudletScheduler().getCloudletExecList().isEmpty() &&
    // AbstractMachine.super.isIdleEnough(time);
    // }

    // HorizontalVGpuScaling getHorizontalScaling ();

    // CustomVGpu setHorizontalScaling (HorizontalVGpuScaling horizontalScaling)
    // throws IllegalArgumentException;

    // CustomVGpu setRamVerticalScaling (VerticalVmScaling ramVerticalScaling)
    // throws IllegalArgumentException;

    // Vm setBwVerticalScaling (VerticalVmScaling bwVerticalScaling) throws
    // IllegalArgumentException;

    // Vm setPeVerticalScaling (VerticalVmScaling peVerticalScaling) throws
    // IllegalArgumentException;
