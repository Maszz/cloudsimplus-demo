package gpusim.cloudlets.gputasks;
...
import gpusim.listeners.GpuTaskVGpuEventInfo;
...
public class GpuTaskSimple implements GpuTask {
    ...
    public boolean addFinishedLengthSoFar(final long partialFinishedMI) {
        ...
        final long maxLengthToAdd = getBlockLength() < 0 ? partialFinishedMI
    ...
    private void returnToGpuCloudletIfFinished() {
        if (isFinished() && !isReturned()) {
            ...
            getSimulation().sendNow(targetEntity, gpuCloudlet.getBroker(), CloudSimTag.CLOUDLET_RETURN,
                    getGpuCloudlet());
    ...
    public UtilizationModel getUtilizationModel(
        ...
        throw new UnsupportedOperationException(
                "This class doesn't support " + resourceClass.getSimpleName() + " resources");
    }
    ...
    // {/**/}
    // @Override public Datacenter getLastTriedDatacenter() { return
    // Datacenter.NULL; }
