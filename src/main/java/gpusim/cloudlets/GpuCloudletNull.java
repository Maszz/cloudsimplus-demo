...
public class GpuCloudletNull implements GpuCloudlet {
    ...
    @Override
    public Cloudlet addOnUpdateProcessingListener(
            org.cloudsimplus.listeners.EventListener<CloudletVmEventInfo> eventListener) {
        return GpuCloudlet.NULL;
    }
    ...
    @Override
    public Startable setFinishTime(double stopTime) {
        return this;
    }

    @Override
    public Startable setLastBusyTime(double time) {
        return this;
    }
    ...
    @Override
    public double getDcArrivalTime() {
        return -1;
    }
    ...
    @Override
    public double getShutdownBeginTime() {
        return -1;
    }
    ...
    @Override
    public Startable setStartTime(double time) {
        return this;
    }

    @Override
    public ExecDelayable setStartupDelay(double delay) {
        return this;
    }

    @Override
    public ExecDelayable setShutdownBeginTime(double shutdownBeginTime) {
        return this;
    }

    @Override
    public double getBrokerArrivalTime() {
        return 0;
    }

    @Override
    public ExecDelayable setShutDownDelay(double delay) {
        return this;
    }

    @Override
    public CustomerEntity setBrokerArrivalTime(double time) {
        return this;
    }
