...
public class PowerSpecFileExample {
     ...
     */
    private static final String POWER_SPEC_FILE = "src/main/resources/power_spec/G6338N.txt";
    ...
    private void printHostCpuUtilizationAndPowerConsumption(final Host host) {
        ...
        double watts = host.getPowerModel().getPower(utilization);
        ...
        //     final double vmUtil = vm.getCpuUtilizationStats().getMean();
        //     System.out.printf("   ↪️ VM %2d Utilization: %6.2f%%%n", vm.getId(), vmUtil * 100);
        // }
    }
    ...
    private List<Cloudlet> createCloudlets() {
        ...
        UtilizationModel utilization = new UtilizationModelDynamic(0.5);
